var ws = null;
var urlPath=document.location.host+document.location.pathname;
{
 if(urlPath.indexOf("/") != -1){  
      urlPath = urlPath.substring(0,  urlPath.lastIndexOf("/")) ;  
 }  
}
var url= 'ws://'+urlPath+'/websocket/ycwx';
//var url= 'ws://20.20.20.100:8018/server/websocket/ycwx';
...
var serverstate = 0; //服务器当前状态标识 {0:主界面;1:示波器界面;2:信号源界面;11:程序下载}
        ...
        case 3:
          if(((getData[di] & 0xff) == 0xfe) && ((getData[di+1] & 0xff) == 0x03)){
            ...
            if(pcm_cvsd_sign == 1)
            {
              // console.log("PCM");
              $(".md3T3").text("PCM调制");
              $(".md3TT1").attr("fill","lime").text("抽样信号");
              $(".md3TT2").text("量化信号");
              ...
              $(".md3T").text("");
              $(".md3T2").text("");
              $(".md3L").attr("y2",1731/4096*oscheight2);
              $(".md3T3").text("CVSD调制");
              $(".md3TT1").attr("fill","rgb(104,104,104)").text("量化噪声");
              $(".md3TT2").text("本地译码");
