...
d3.select("#pic_s51")
  .append("g")
  .attr("class","51poonts")
  .attr("transform","translate(37,210.5)")
  .selectAll("g")
  .data(new Array(4))
  .enter()
  .append("g")
  ...
  .each(function(d,i){
    ...
    d3.select(this)
      ...
      .attr({
        ...
        cx:6,
        cy:function(d,i){return 6+i*14.8;},
        r:6,
        fill:"transparent",
        stroke:"black"
      })
...
d3.select("#pic_s51")
  .append("g")
  .attr("class","keypoints")
  .attr("transform","translate(43,150)")
  .selectAll("circle")
  .data([{cx:222.5,cy:68},{cx:222.5,cy:104},{cx:223,cy:141},{cx:222.5,cy:178},{cx:222.5,cy:215},{cx:222.5,cy:244},{cx:222.5,cy:274},{cx:222.5,cy:304},{cx:222.5,cy:355},
        {cx:94.5,cy:6},{cx:65.5,cy:6},{cx:35.5,cy:6},{cx:6,cy:6}])
  .enter()
  .append("circle")
  .attr({
    class:"pt1",
    addr:function(d,i){if(i<9){return "0x"+(0x2021+i).toString(16);}else{return "0x"+(0x1019+i-9).toString(16)}},
...
var s51psetted = new Array(),keypsetted = new Array(),oscp01setted = new Array(),logpsetted = new Array(),
...
for(var i=0 ;i < 13;i++){keypsetted[i] = 0;}
...
$_keyp_01.each(function(){
  ...
  $(this).click(function(){
    ...
    if(maplinelock == 2)
    {
      ...
      // console.log(deviceId);
      if(m < 9){
        websend_fpga((0x2020+val),(parseInt($(".pt0[ms="+s51_setsign+"]").attr("val")) & 0xff));
        console.log('addr: 0x%s,val: 0x%s',(0x2020+parseInt(t.attr("val"))).toString(16),(parseInt($(".pt0[ms="+s51_setsign+"]").attr("val")) & 0xff).toString(16));
      }else{
        websend_fpga((0x1011+val-2),(parseInt($(".pt0[ms="+s51_setsign+"]").attr("val")) & 0xff));
        console.log('addr: 0x%s,val: 0x%s',(0x1011+val-2).toString(16),(parseInt($(".pt0[ms="+s51_setsign+"]").attr("val")) & 0xff).toString(16));
      }
    }
