...
d3.select("#pic_lcd")
  ...
  .attr({
    class:"pt1",
    addr:function(d,i){return "0x"+(0x2001+i).toString(16)},
...
$_ledp_01.each(function(){
  ...
  $(this).click(function(){
    ...
    if(maplinelock == 2)
    {
      ...
      console.log("addr: 0x%s,val: 0x%s",(0x2000+parseInt(t.attr("val"))+1).toString(16),(parseInt($(".pt0[ms="+s51_setsign+"]").attr("val")) & 0xff).toString(16));
    }
