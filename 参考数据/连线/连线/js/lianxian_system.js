...
d3.select("#pic_s51")
  .append("g")
  .attr("class","51poonts")
  .attr("transform","translate(145,304)")
  .selectAll("g")
  .data(new Array(4))
  .enter()
  .append("g")
...
d3.select("#pic_s51")
  ...
  .attr("transform","translate(95.5,78)")
  .selectAll("circle")
  .data([{cx:0,cy:94,val:8,m:2,k:3},{cx:188,cy:94,addr:'0x2051',m:1},{cx:245,cy:94,val:2,m:2,k:2},{cx:415,cy:92,addr:'0x2013',m:1},
        {cx:452,cy:92,addr:'0x2014',m:1},{cx:490,cy:92,addr:'0x2015',m:1},{cx:528,cy:92,addr:'0x2016',m:1},{cx:547,cy:0,addr:'0x2012',m:1}])
  .enter()
  .append("circle")
  .attr({
    class:"pt1",
          ...
          $.contextMenu({
              ...
              callback: function(key, options) {
                  if(key == "delete"){
                    $(this).remove();
                    s51psetted[parseInt($(this).attr("ms"))] = 0;
                    var val = s51psetted[2]*2 + s51psetted[3]*8;
